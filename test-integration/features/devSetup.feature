Feature: This is just helper for dev work
  ...
  Scenario: Add accounts for jrn, nishant and rashi
    ...
    # nishant uploads a file with correct repoId and docId
    When i am logged in as nishant@jrn-limited.com
    ...
    # nishant uploads a file with correct repoId and docId
    When i am logged in as nishant@jrn-limited.com
    And i submit create doc request with for account with name 'JRN Main Account' and repo with name 'UK KYC' and customer name 'Lucy John Dale'
    Then i should get response with status code 200
    When i upload test-integration/files/DL-02.jpeg with 'saved_repoId' and 'saved_docId' and type 'drivingLicence'
    Then i wait for last_created doc to get 'indexed'
    And text for last_created doc is populated
    And last_uploaded_file is removed from upload bucket

    # nishant uploads 10 docs
#    And i upload 50 documents
